...
<ol><b>
    ...
    <li>Transaksi dianggap batal jika sampai dengan pukul <b><?php echo date('H:i', strtotime($tanggal_bayar)) ?></b> WIB hari <b><?php echo $tanggal_bayar_print;?></b> (1×12 jam) pembayaran belum dilunasi.</li>
...
konfirmasi bahwa Anda telah memahami dan menyetujui ketentuan transaksi di atas. Kandhang akan mengirim tagihan pembayaran ke <?php echo $_SESSION['email']; ?>
</b><br>
...
<tr>
<td>$no_urut</td>
<td><img src='images/".$data['hewan_foto']."' width='100' height='100'></td>
<td>".$data['hewan_bobot']."Kg</td>
<td>Rp.".number_format($data['hewan_harga_jual'],2,",",".")."</td>
</tr>";
...
<td colspan='2'><h1>Rp".number_format($total_harga,2,",",".")."</h1></td>
</tr>
...
$pesan_kd="<h1>hi Rudi anda telah memesan </h1>";

$kirim="$pesan_kd $table_atas $header $isi $isi_bawah $table_bawah";
