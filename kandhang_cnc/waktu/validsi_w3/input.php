...
<html>
	...
	<body>
		...
		<table>
			<tr>
				<td>Username: </td>
				<td><input type="text" name="username" value="<?php @$username?>"/> (3 to 20 alpha-numeric characters)</td>
			</tr>
			<tr>
				<td>First name: </td>
				<td><input type="text" name="first_name" value="<?php @$first_name?>"/> (3 to 20 alpha characters only)</td>
			</tr>
			<tr>
				<td>Last name: </td>
				<td><input type="text" name="last_name" value="<?php @$last_name?>"/> (3 to 20 alpha characters only)</td>
			</tr>
			<tr>
				<td>Password: </td>
				<td><input type="password" name="password" value="<?php @$password?>"/> (3 to 20 characters only)</td>
			</tr>
			<tr>
				<td>Confirm password: </td>
				<td><input type="password" name="confirm_password" value="<?php @$confirm_password?>"/> (3 to 20 characters only)</td>
			</tr>
			<tr>
				<td>Email: </td>
				<td><input type="text" name="email" value="<?php @$email?>"/> (Valid email like name@domain.com)</td>
			</tr>
			<tr>
				<td>Phone: </td>
				<td><input type="text" name="phone" value="<?php @$phone?>"/> (10 digit mobile number)</td>
			</tr>
			<tr>
				<td>Gender: </td>
			...
			<tr>
				<td>Date of Birth: </td>
				<td><input type="number" name="day" value="<?php @$day?>" size=2/>/
					<input type="number" name="month" value="<?php @$month?>" size=2/>/
					<input type="number" name="year" value="<?php @$year?>" size=4/> (DD/MM/YYYY)</td>
			</tr>
			<tr>
				<td>Bio: </td>
				<td><textarea name="bio"><?php @$bio?></textarea></td>
			</tr>
		</table>			
