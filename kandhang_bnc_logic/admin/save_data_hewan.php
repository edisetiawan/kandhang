...
/*echo "<b>foto : </b>".$_SESSION['foto_name']."<br><b>nama : </b> ".$var_nama."<br><b>kategori : </b> ".$var_kategori."<br> <b>jenis kelamin : </b>
...
$sql_Insert="INSERT INTO tb_hewan VALUES ('','".$_SESSION['foto_name']."','$var_nama_hewan','$var_jenis_kelamin','$var_bobot','$var_harga_beli',
'$var_harga_jual','$var_deskripsi','$date','$var_kategori')";
//echo $sql_Insert;
//exit;
